...
public class StatusEffectIceBlock extends StatusEffectShell{

	public StatusEffectIceBlock(Skill skill, int seconds) {
		
		super(null, skill, "Iceblock", 0, 0, 0, -1, 1, 0, 0, 100, false, false, false, seconds+1, 0);
	}
